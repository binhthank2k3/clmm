...
CREATE TABLE `options`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 78 CHARACTER SET = utf8 COLLATE = utf8_vietnamese_ci ROW_FORMAT = DYNAMIC;
...
INSERT INTO `options` VALUES (72, 'views', '1702');
...
INSERT INTO `options` VALUES (77, 'noidung_chanle', 'Trả thưởng phiên ');
