                ...
                <div class="card card-outline card-primary">
                    ...
                    <div class="card-body">
                        <form action="" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                <i>Lưu ý: Nếu 1 tài khoản MOMO vừa trả thưởng vừa nhận tiền thì bạn thêm tài khoản đó
                                    vào hệ thống 2 lần nhé,1 lần OFF 1 lần ON.</i>
                            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-primary btnEdit"
                                                href="<?=BASE_URL('public/admin/edit-momo.php?id='.$row['id']);?>"><i
                                                    class="fas fa-edit"></i>
                                                <span>EDIT</span>
                                            </a>
                                            <a class="btn btn-info"
                                                href="<?=BASE_URL('public/admin/pay-momo.php?id='.$row['id']);?>"><i
                                                    class="fas fa-money-bill-wave"></i>
                                                <span>CHUYỂN TIỀN</span>
                                            </a>
                                            <a class="btn btn-danger btnDelete"
                                                href="<?=BASE_URL('public/admin/momo.php?delete='.$row['id']);?>"><i
