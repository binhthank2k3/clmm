...
if(isset($_POST['btnTimKiem']))
{
    ...
    $total_cuoc         = $CMSNT->get_row("SELECT SUM(`amount`) FROM `momo` WHERE `gettime` >= '".$daterangepicker[0]."' AND `gettime` <= '".$daterangepicker[1]."' ")['SUM(`amount`)'];
...
else
{
    ...
    $total_cuoc          = $CMSNT->get_row("SELECT SUM(`amount`) FROM `momo`  ")['SUM(`amount`)'];
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-12">
                <div class="small-box bg-warning">
                    <div class="inner">
                        <h3><?=format_cash($CMSNT->get_row("SELECT SUM(`amount`) FROM `momo` ")['SUM(`amount`)']);?>đ
                        </h3>
            ...
            <div class="col-lg-2 col-12">
                <div class="small-box bg-info">
                    <div class="inner">
                        <h3><?=format_cash($CMSNT->num_rows("SELECT * FROM `momo` WHERE `status` = 'refund' OR `status` = 'paid' AND `gettime` >= DATE(NOW()) AND `gettime` < DATE(NOW()) + INTERVAL 1 DAY "));?>
                        </h3>
                        <p>Lượt chuyển tiền hôm nay</p>
                    </div>
                    <div class="icon">
            ...
            <div class="col-lg-2 col-12">
                <div class="small-box bg-warning">
                    <div class="inner">
                        <h3><?=format_cash($CMSNT->get_row("SELECT SUM(`amount`) FROM `momo` WHERE `status` = 'unpaid' OR `status` = 'waiting-refund'  ")['SUM(`amount`)']);?>đ
                        </h3>
                        <p>Số tiền đang chờ trả thưởng & hoàn</p>
                    </div>
                    <div class="icon">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p>1.1.5: Thêm chức năng chuyển tiền qua ví MOMO khác tại Website.</p>
                <br>
